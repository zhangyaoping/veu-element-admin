  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item"
                placeholder="标题" v-model="listQuery.title">
      </el-input>
    ...
    <el-table :key='tableKey' :data="tablelist" v-loading="listLoading" element-loading-text="加载中..." border fit
      ...
      <el-table-column width="110px" v-if='showReviewer' align="center" label="作者">
        <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        this.Api.getTableList().then(res => {
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            this.Api.createArticle(this.temp).then(res => {
              this.tablelist.unshift(this.temp)
      ...
      updateData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            this.Api.updateArticle(tempData).then(res => {
              this.tablelist.unshift(this.temp)
              this.dialogFormVisible = false
              this.$notify({
                title: '成功',
      ...
      handleFetchPv(pv) {
        this.Api.getFetchPv(pv).then(res => {
